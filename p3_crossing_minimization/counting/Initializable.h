...
public:
    ...
    virtual void initAtLayerLevel(int l, std::vector<std::vector<std::shared_ptr<Node>>> &nodeOrder){};
    virtual void initAtNodeLevel(int l, int n, std::vector<std::vector<std::shared_ptr<Node>>> &nodeOrder){};
    virtual void initAtPortLevel(int l, int n, int p, std::vector<std::vector<std::shared_ptr<Node>>> &nodeOrder){};
    ...
    virtual void initAfterTraversal(){};
};
}  // namespace GuiBridge
